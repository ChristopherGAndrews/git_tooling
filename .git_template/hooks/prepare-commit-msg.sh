...
# From: https://github.com/atlassian/atlascode/blob/main/scripts/prepare-commit-jira.sh
# License: https://github.com/atlassian/atlascode/blob/main/LICENSE
# This commit hook will extract a Jira issue key from your branch name (you are naming your branches with issue key’s aren’t you?) and append it to all commit messages so that many pla
ces across our products can glue commits together with issues.
#
# To use this:
#
...
#
# Once you found where your .git_config file is, follow the above instructions. I did not need to change the proposed templatedir value in step 4, nor the shebang in the file, but your
 mileage may vary.
#
